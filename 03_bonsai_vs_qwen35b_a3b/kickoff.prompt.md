...
TRANSCRIPT_FILE=`03_bonsai_vs_qwen35b_a3b.txt`
VIDEO_TITLE=`Can a 3.5GB model replace my 35B daily driver? (Bonsai 27B)`
VIDEO_URL=`https://www.youtube.com/watch?v=rBLWDJrXCp0`
...
- If not specified, inspect the current host and adapt conservatively. NEVER CHANGE THE CURRENT HOST. ASK FOR DEPENDENCIES IF NEEDED. DO NOT INSTALL THEM YOURSELF.
